...
public interface ITransactionRepository
{
    ...
    Task<IEnumerable<Transaction>> GetByUserIdAndTickerAsync(Guid userId, string ticker);
    ...
    Task<long> GetNextVersionAsync(Guid userId, string ticker);
    Task<decimal> GetCurrentPositionAsync(Guid userId, string ticker);
}